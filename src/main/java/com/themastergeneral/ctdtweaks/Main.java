...
@Mod(modid = Main.MODID, name = Main.MODNAME, version = Main.VERSION, dependencies = Main.DEPENDENCIES, updateJSON = Main.updateJSON, certificateFingerprint = Main.Fingerprint)
public class Main {
