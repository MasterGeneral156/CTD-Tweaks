...
public class Config 
{
    ...
    private static void initGeneralConfig(Configuration cfg) 
    {
        ...
        hasteringmodifier = cfg.getInt("Haste Ring Modifier", CATEGORY_GENERAL, hasteringmodifier, 1, 255, "What level of Haste should the ring give?");
        speedringmodifier = cfg.getInt("Speed Ring Modifier", CATEGORY_GENERAL, speedringmodifier, 1, 255, "What level of Speed should the ring give?");
    }
}
