...
public class JEICTDTweaksPlugin extends BlankModPlugin {
	...
	public void register(@Nonnull IModRegistry registry) {
		registry.addDescription(new ItemStack(ModItems.corecombat),
				"jei.corecombat.info");
		registry.addDescription(new ItemStack(ModItems.glowingamulet),
				"jei.amulet.info");
		registry.addDescription(new ItemStack(ModItems.fuelwither),
				"jei.fuelwither.info");
		registry.addDescription(new ItemStack(ModBlocks.fuelwitherblock),
				"jei.fuelwither.info");
		...
		registry.addDescription(new ItemStack(ModItems.hastering),
				"jei.hastering.info");
		registry.addDescription(new ItemStack(ModItems.speedring),
				"jei.speedring.info");
	}
}
